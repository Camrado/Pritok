      ...
      <div class="modal-wrapper">
        <div class="modal-container">
          <div class="modal-header align-items-center">
            <h4 class="modal-title mb-0">Delete Category</h4>
            <i class="el-icon-close" style="cursor: pointer;" @click="showModal = false" />
          </div>
          <div class="modal-body text-center">
            <p class="mb-4 mt-2">Are you sure that you want to permanently delete the selected category?</p>
            <div class="text-right">
              <el-button type="danger" @click="deleteCategory()" :loading="loadingBtn">Submit</el-button>
...
export default {
  ...
  setup(props) {
    ...
    // fetch function to delete category and show toast notification
